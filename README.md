...
│   ├── tulip-importers/    # OFX, QIF, CSV, PTA (hledger)
...
- **PTA (Phase 7, hledger-format round-trip):** `GET /v1/pta/export[?format=hledger&start=...&end=...]`, `POST /v1/pta/import` (text/plain body → PENDING transactions)
